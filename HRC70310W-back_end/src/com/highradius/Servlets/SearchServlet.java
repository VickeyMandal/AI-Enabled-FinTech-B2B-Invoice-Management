...
public class SearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//SELECT * FROM winter_internship WHERE cust_number=140106181 AND invoice_id=12000822 AND buisness_year=2022 AND doc_id=12000894
			String query = "SELECT * FROM winter_internship where cust_number="+custNum+" and invoice_id="+invoiceId+" and buisness_year="+busYear+" and doc_id="+docId;
			...
			//String sql = "SELECT COUNT(*) invoice_count FROM winter_internship WHERE cust_number="+search;
			String sql = "SELECT COUNT(*) invoice_count FROM winter_internship WHERE cust_number="+custNum+" and invoice_id="+invoiceId+" and buisness_year="+busYear+" and doc_id="+docId;
